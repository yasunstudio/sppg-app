...
export function RecipeCreate() {
  ...
  const form = useForm<RecipeFormValues>({
    ...
    defaultValues: {
      ...
      notes: "",
      isActive: true,
      ingredients: [{ itemId: "", quantity: 1, unit: "", notes: "" }],
    },
  })
  ...
  const addIngredient = () => {
    append({ itemId: "", quantity: 1, unit: "", notes: "" })
  }
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-4">
          ...
          <div>
            <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100">Create New Recipe</h1>
            <p className="text-sm text-gray-500 dark:text-gray-400">
              Add a new recipe for food production
            </p>
          </div>
        </div>
        <ThemeToggle />
