...
import { MenuEditIngredientSelector } from './menu-edit-ingredient-selector'

interface MenuEditItemsSectionProps {
  form: any
}
...
export function MenuEditItemsSection({ form }: MenuEditItemsSectionProps) {
        ...
        {fields.length === 0 ? (
          ...
          <div className="space-y-6">
            <Alert>
              ...
              <AlertDescription>
                Changes to existing menu items will be saved when you submit the form. Deleted items will be permanently removed.
              </AlertDescription>
            </Alert>

            {fields.map((field, index) => {
              const category = ITEM_CATEGORIES.find(cat => cat.value === watch(`menuItems.${index}.category`))
              const isExisting = !!(field as any).id // Check if this is an existing item
                  ...
                  <CardContent className="space-y-6">
                    <Tabs defaultValue="basic" className="w-full">
                      <TabsList className="grid w-full grid-cols-2">
                        ...
                        <TabsTrigger value="ingredients">
                          ...
                          <Badge variant="secondary" className="ml-2">
                            {watch(`menuItems.${index}.ingredients`)?.length || 0}
                          </Badge>
                        </TabsTrigger>
                      </TabsList>
                      ...
                      <TabsContent value="ingredients" className="mt-4">
                        <MenuEditIngredientSelector form={form} menuItemIndex={index} />
                      </TabsContent>
                    </Tabs>
                  </CardContent>
                </Card>
