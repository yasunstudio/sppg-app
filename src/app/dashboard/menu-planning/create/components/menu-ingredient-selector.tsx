...
import { RawMaterial } from '../types/menu-form-types'

interface MenuIngredientSelectorProps {
  form: any
  menuItemIndex: number
}

export function MenuIngredientSelector({ form, menuItemIndex }: MenuIngredientSelectorProps) {
  const [searchTerm, setSearchTerm] = useState('')
  const { control, watch, setValue } = form

  const { fields, append, remove } = useFieldArray({
    control,
    name: `menuItems.${menuItemIndex}.ingredients` as const
  })
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                    ...
                    <div className="space-y-2">
                      ...
                      <Input
                        ...
                        step="0.1"
                        min="0.1"
                        {...form.register(`menuItems.${menuItemIndex}.ingredients.${ingredientIndex}.quantity`, { valueAsNumber: true })}
