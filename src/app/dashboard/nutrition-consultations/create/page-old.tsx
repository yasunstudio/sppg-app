import { NutritionConsultationCreate } from '../components/nutrition-consultation-create'

export default function NutritionConsultationCreatePage() {
  return <NutritionConsultationCreate />
}
