    ...
    const loadItem = async () => {
      try {
        ...
        setFormData({
          ...
          unit: mockItem.unit,
          unitPrice: mockItem.unitPrice ? mockItem.unitPrice.toString() : "",
          allergens: mockItem.allergens,
          shelfLife: mockItem.shelfLife ? mockItem.shelfLife.toString() : "",
          storageRequirement: mockItem.storageRequirement || "",
          supplierId: mockItem.supplierId || "",
        ...
        <div className="flex items-center space-x-4">
          ...
          <div>
            ...
            <p className="text-muted-foreground">
              Perbarui informasi item dan bahan baku
            </p>
          </div>
        </div>
      </div>
