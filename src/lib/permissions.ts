...
export const PERMISSIONS = {
  ...
  // Vehicle Management
  'vehicles.create': ['SUPER_ADMIN', 'ADMIN', 'DISTRIBUTION_MANAGER', 'OPERATIONS_SUPERVISOR'],
  'vehicles.view': ['SUPER_ADMIN', 'ADMIN', 'DISTRIBUTION_MANAGER', 'OPERATIONS_SUPERVISOR', 'DRIVER'],
  'vehicles.edit': ['SUPER_ADMIN', 'ADMIN', 'DISTRIBUTION_MANAGER', 'OPERATIONS_SUPERVISOR'],
