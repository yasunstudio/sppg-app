...
export async function seedUsers() {
  ...
  const users = [
    ...
    },
    {
      ...
      username: 'andi-prod',
      email: 'andi.production@sppg.com',
    ...
    },
    {
      ...
      username: 'rina-dist',
      email: 'rina.distribution@sppg.com',
